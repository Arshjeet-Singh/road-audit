...
globalkoshish =["trafficlight","chevron_markers","speedlimit","pavement_markers","crosswalk","stop"]
...
if selected == "Object Detection":
    ...
    def main():
        ...
        cocoClassesLst = ["trafficlight","chevron_markers","speedlimit","pavement_markers","crosswalk","stop", "All"]
                    ...
                    with st.spinner(text = 'Preparing Images'):
                        ...
                        for i in range(len(globalkoshish)):
                            if dictkoshish[globalkoshish[i]]=="Yes":
                                ...
                                dictkoshish[globalkoshish[i]]="No"
                            else:
